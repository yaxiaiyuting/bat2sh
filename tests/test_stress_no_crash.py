...
FROZEN_WARNINGS = [
    ...
    (205, 'variables', '%ERRORLEVEL% 的转换可能不完全等价'),
    (208, 'variables', '%SystemRoot% 的转换可能不完全等价'),
    (215, 'command', "未知命令 'certutil'，请确认 Linux 下可用"),
    ...
    (310, 'command', "未知命令 'driverquery'，请确认 Linux 下可用"),
    ...
    (451, 'command', "未知命令 'driverquery'，请确认 Linux 下可用"),
    (460, 'command', "未知命令 'query'，请确认 Linux 下可用"),
    (466, 'command', "未知命令 'certutil'，请确认 Linux 下可用"),
